...
async def _bad_llm_narrative_is_not_cached(monkeypatch):
...
async def _good_llm_narrative_critical_is_accepted(monkeypatch):
...
def test_reflex_bad_llm_narrative_is_not_cached_falls_back_to_deterministic(monkeypatch):
    asyncio.run(_bad_llm_narrative_is_not_cached(monkeypatch))


def test_reflex_good_llm_narrative_critical_is_accepted(monkeypatch):
    asyncio.run(_good_llm_narrative_critical_is_accepted(monkeypatch))
